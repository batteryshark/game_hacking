...
def unpack_decrypt_card(inpath):
	f = open(inpath,"rb")
	indata = f.read()
	f.close()
	if(indata[0] == b'\x09'):
	...
	out.write(indata)
	out.close()
	os.system("delha.exe 1>nul")
	if(dodec):
		os.system("c:\\python27\\python.exe card_dcrypt.py out.tmp")
		os.rename("out.dec","crd.tmp")
	else:	
		os.rename("out.tmp","crd.tmp")
...
class Card(object):
	...
	type_table = {0x11:"Fire",0x12:"Water",0x13:"Earth",0x14:"Air",0x10:"Neutral",0x18:"Spell_Buff",0x28:"Spell_Curse",0x38:"Spell_Attack",0x90:"Weapon",0xA0:"Armor",0xB0:"Tool",0xC0:"Scroll"}
	item_limit_table = {0x00:"None",0x01:"Weapons",0x2:"Armor",0x3:"Weapons, Armor",0x8:"Scrolls",0x9:"Weapons, Scrolls",0xA:"Armor, Scrolls",0xB:"Weapons, Armor,Scrolls",0x0E:"Armor, Tools, Scrolls"}
	land_limit_table = {0x00:"None",0x2:"Fire",0x4:"Water",0x8:"Earth",0x10:"Air",0x12:"Fire, Air",0x13:"Fire, Air",0x14:"Water, Air"}
...
if(__name__ == "__main__"):
	unpack_decrypt_card(sys.argv[1])
	card = Card("crd.tmp")
	card.dump_card()
