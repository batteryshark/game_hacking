...
namespace theli
{
    class CuldceptCommon
    {
        ...
        private static byte[] CuldDeLHA(BinaryReader br)
        {
            ...
            //System.Console.WriteLine("Algo = "+algo.ToString("D"));
            Int32 uncompsize;
            Int32 b = br.ReadSByte();
          //  System.Console.WriteLine("b = " + b.ToString("D"));
            uncompsize = br.ReadByte();
            //System.Console.WriteLine("uncompsize= " + uncompsize.ToString("D"));
            uncompsize |= (b << 8);
            //System.Console.WriteLine("uncompsize= " + uncompsize.ToString("D"));
            ...
            //    data = Lha.LHADecode(Lha.LzhCompressMethodType.LH7, data, uncompsize);
                ...
                data = Lha.LHADecode(Lha.LzhCompressMethodType.LH6, data, uncompsize);
            else if (algo == 0xA)
                data = Lha.LHADecode(Lha.LzhCompressMethodType.LH4, data, uncompsize);
            else
